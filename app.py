...
# Sample car data
with open("xgboost3hypara_model_pipeline.pkl", "rb") as f:
    model = pickle.load(f)
...
def predict():
        try:
            ...
            return render_template("index.html", prediction_text=f"Prediction rate :$:{pred}")
...
if __name__ == '__main__':
    app.run(debug=True)
>>>>>>> 00a31bccf065a562de0d27e19b3dce9ebcefe42d
